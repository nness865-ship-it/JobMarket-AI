...
var isCSSVariableToken = (value) => {
  ...
  if (!startsWithToken)
    return false;
  return singleCssVariableRegex.test(value.split(" new Set(["none", "hidden"]);
...
var acceleratedValues2 =  new Set([
  "opacity",
  "clipPath",
  "filter",
  "transform"
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", anchorY = "top", root }) => {
  ...
  const exitingComponents = (0, import_react10.useRef)( new Set());
...
var threshold = 50;
var maxSpeed = 25;
var overflowStyles2 =  new Set(["auto", "scroll"]);
var initialScrollLimits =  new WeakMap();
var activeScrollEdge =  new WeakMap();
